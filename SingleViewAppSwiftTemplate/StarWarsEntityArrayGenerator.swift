//
//  StarWarsEntityArray.swift
//  SingleViewAppSwiftTemplate
//
//  Created by Michael Guatambu Davis on 12/6/17.
//  Copyright © 2017 Treehouse. All rights reserved.
//

import Foundation

class StarWarsEntityArrayGenerator {
    // using the downloaded JSON data from the SWAPI which is a nested array of objects under the key "results" (best represented as a dictionary here in Swift/iOS) of the downloaded JSON object array
